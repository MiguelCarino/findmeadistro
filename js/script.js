...
var color_list = [
    "#ED5565", "#48CFAD", "#FC6E51", //red, torquoise, orange
...
var distro_list = [
    "TEST", "FMALDALL", "FMALDDEBIAN", "FMALDARCH", "FMALDGENTOO", "FMALDFEDORA", "FMALDSUSE", "FMALDSLACK", "FMALDBSD", "FMALDOTHER"
];
...
function clicked() {
    ...
    var distrolink_list = [
        ...
        fedoralinks, suselinks, slacklinks, bsdlinks, otherlinks
    ];

    var eoldistrolink_list = [
        "gap", EOLlinks, EOLdebianlinks, EOLarchlinks, EOLgentoolinks,
        EOLfedoralinks, EOLsuselinks, EOLslacklinks, EOLbsdlinks, EOLotherlinks
    ];
...
function changeButtonColor() {
    ...
    if (color_list[color] == curr_color || color_list[color] == prev_color) {
        ...
        document.getElementById("FMALDFEDORA").style.backgroundColor = "#3D3D3D";
